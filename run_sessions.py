...
def main(path, fn):
    ...
    result_f = open('eval_results/sessions/final/' + fn, 'w')
    # load file
    lines = transcripts_sessions.load(fn, path)
    sent_pairs = transcripts_sessions.get_sent_pairs(lines)
    total_terms = 0
